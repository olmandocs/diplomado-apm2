...
function getHeading(){
	 ...
	 navigator.compass.getCurrentHeading(onHeadingSuccess, onHeadingError);//posición actual recibe métodos exito y error
}
...
function onHeadingSuccess(compass){
	...
	console.log(compass.magneticHeading, compass.trueHeading, compass.headingAccuracy, date.toLocaleString());//magnetic con respecto al polo magnetico, current con respecto al norte
