...
if(minutes < 10){
	minutes = "0" + minutes; // agrega un cero a la izquierda si son números menores a 10 CONVERSION NO IMPLICITA
} else {
	minutes = minutes.toString(); // convertir la variable `minutes` en un string o cadena de caracteres CONVERSION IMPLICITA
}
...
time = Number(hours + minutes);//CONCATENA Y CREA UN NUMERO
